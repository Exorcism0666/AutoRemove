...
# Add manosim.gitify to Update List
    ...
    id = "Fly-io.flyctl"
    JSON = requests.get("https://api.github.com/superfly/flyctl/releases/latest", verify=False, headers=Headers[1]).json()["assets"]
    Version = requests.get("https://api.github.com/superfly/flyctl/releases/latest", verify=False, headers=Headers[1]).json()["tag_name"]
    ...
    JSON = requests.get("https://api.github.com/nextdns/nextdns/releases/latest", verify=False, headers=Headers[1]).json()["assets"]
    Version = requests.get("https://api.github.com/nextdns/nextdns/releases/latest", verify=False, headers=Headers[1]).json()["tag_name"]
    ...
    id = "AdGuard.dnsproxy"
    JSON = requests.get("https://api.github.com/AdguardTeam/dnsproxy/releases/latest", verify=False, headers=Headers[1]).json()["assets"]
    Version = requests.get("https://api.github.com/AdguardTeam/dnsproxy/releases/latest", verify=False, headers=Headers[1]).json()["tag_name"]
    ...
    JSON = requests.get("https://api.github.com/AdguardTeam/AdGuardHome/releases/latest", verify=False, headers=Headers[1]).json()["assets"]
    Version = requests.get("https://api.github.com/AdguardTeam/AdGuardHome/releases/latest", verify=False, headers=Headers[1]).json()["tag_name"]
